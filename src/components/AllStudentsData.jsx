    ...
    <div className=" md:p-6 lg:p-8 bg-gradient-to-br from-gray-900 to-gray-800 min-h-screen">
      {loading ? (
        ...
        <div className="text-red-500 text-2xl flex flex-col items-center justify-center gap-4 mt-10 text-center">
          <BiErrorCircle className="text-5xl font-bold animate-spin" />
          <p>{error}</p>
        </div>
      ) : (
              ...
              >
                ...
                <div className="p-6 text-sm space-y-3 text-gray-300">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <p><span className="text-gray-400">Laptop:</span> {student.laptopAvailable}</p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 px-5 py-3 bg-gray-700 border-t border-gray-600">
                  {verifyBtnLoading ? (
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 rounded-lg cursor-pointer font-semibold transition-all duration-200 text-white ${student.profileVerified ? 'bg-gray-600 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700'}`}
                    >
